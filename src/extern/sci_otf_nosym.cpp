...
extern "C"
{
    ...
    {
        return build_network_otf<uint32, double>(orbsym, norb, ngs, axs, bxs,
    ...
    void get_diags_elements_sci_nosym_f64(void *basis, void *net, double *diags)
    {
        ...
        get_diags_elements_sci_nosym<uint32, double>(bs, otf, diags);
    }
    ...
    {
        destroy_sci_basis_manager_nosym<uint32>(static_cast<SciBasisManagerNosym<uint32> *>(ptr));
    }
}
